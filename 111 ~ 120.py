...
# 단 출력 값의 범위는 0~255이다. 예를 들어 결괏값이 0보다 작은 값이되는 경우
...
# 딕셔너리 키 (key) 값에 포함되었다면 "정답입니다"를 아닐
# 경우 "오답입니다" 출력하라.
...
# 아래와 같이 fruit 딕셔너리가 정의되어 있다. 사용자가 입력한 값이
# 딕셔너리 값 (value)에 포함되었다면 "정답입니다"를 아닐
# 경우 "오답입니다" 출력하라.
